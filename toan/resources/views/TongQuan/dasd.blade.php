                ...
                <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body" style="overflow: auto;">
                                    ...
                                    <div class="form-group" style="margin-bottom: 25px;">
                                      ...
                                      <select style="width: 60%; float: right;overflow: scroll;" name="" id="input" class="form-control" required="required">
                                        ...
                                        <option value="">Nguyễn Văn F</option>
                                        <option value="">Nguyễn Văn G</option>
                                        <option value="">Nguyễn Văn D</option>
                                        <option value="">Nguyễn Văn E</option>
                                        <option value="">Nguyễn Văn F</option>
                                        <option value="">Nguyễn Văn G</option>
                  ...
                  <div class="row">
                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 bao">
                      ...
                      <div><h3>Mã đơn hàng: FFAA1212</h3></div>
                              ...
                              <div class="panel panel-info">
                                ...
                                <ul class="list-group" styl>
                                  <li class="list-group-item">
                                      ...
                                      <i style="font-size: 13px; opacity: 0.6">Ngày 13/03/2019 23:12 - new-user</i>
                                  </li>
                                  <li class="list-group-item">
